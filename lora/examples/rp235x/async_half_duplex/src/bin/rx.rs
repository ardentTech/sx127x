//! This example demonstrates CAD and TX by checking for channel activity before transmitting a 255 byte payload. The green led on GPIO 21 will pulse on
...
use common::{half_duplex_config, led_task, Led, PULSE_LED};
...
async fn main(spawner: Spawner) {
    ...
    let mut sx127x = Sx127xLora::new_with_config(spi_dev, half_duplex_config()).await.unwrap();
